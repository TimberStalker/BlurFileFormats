...
using BlurFileFormats.SerializationFrameworkOld.Command.Meta;
using BlurFileFormats.SerializationFrameworkOld.Command.Meta.Position;
using BlurFileFormats.SerializationFrameworkOld.Command.Numeric;
using BlurFileFormats.SerializationFrameworkOld.Command.Sequence.Strings;
using BlurFileFormats.SerializationFrameworkOld.Commands;
using BlurFileFormats.SerializationFrameworkOld.Commands.Meta.Position;
using BlurFileFormats.SerializationFrameworkOld.Commands.Sequence;
using BlurFileFormats.SerializationFrameworkOld.Attributes;
using BlurFileFormats.SerializationFrameworkOld.Commands;
...
public class ReadProperty : IRead
{
    ...
    public void Build(List<ISerializerPropertyCommand> commands, TypeTree tree)
    {
        ...
        {
            var constCommand = (IGetCommand)Activator.CreateInstance(typeof(ConstantExpressionCommand<>).MakeGenericType(Property.PropertyType), args: [(Func<object, object>)(v => Property.GetValue(v)!)]);
